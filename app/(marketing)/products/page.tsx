...
const products = [
  {
    ...
    description:
      "Set up your store in under an hour — no developer needed. Beautiful themes, integrated payments, built-in SEO, and real human support. Rated 4.9/5 from 150+ reviews.",
    icon: ShoppingBag,
              ...
              >
                ...
                >
                  ...
                  <div className="lg:w-2/3">
                    ...
                    {/* Features Grid */}
                    <StaggerContainer className="mt-6 grid grid-cols-2 gap-2 sm:grid-cols-3" staggerDelay={0.05}>
                      {product.features.map((feature) => (
                        <StaggerItem key={feature} variant="fade-in">
