...
export default function AppEmailTemplatesPage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    <>
      ...
      <main className="p-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          {activeTab === "templates" && (
            <Link href={`/admin/apps/${slug}/email-templates/new`}>
              <Button>
                    ...
                    {templates.map((template) => (
                      ...
                      >
                        <td className="px-4 py-3">
                          <Link
                            href={`/admin/apps/${slug}/email-templates/${template.id}`}
                        ...
                        <td className="px-4 py-3 text-right">
                          <Link href={`/admin/apps/${slug}/email-templates/${template.id}`}>
            ...
            {notificationsLoading ? (
              ...
              <div className="rounded-md border">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b bg-muted/50">
                      <th className="h-10 px-4 text-left font-medium text-muted-foreground">Recipient</th>
                      <th className="h-10 px-4 text-left font-medium text-muted-foreground">Subject</th>
                      <th className="h-10 px-4 text-left font-medium text-muted-foreground">Template</th>
                      <th className="h-10 px-4 text-left font-medium text-muted-foreground">Status</th>
                      <th className="h-10 px-4 text-left font-medium text-muted-foreground">Sent At</th>
                    </tr>
                  </thead>
                  <tbody>
