...
export default function AppEmailTemplateEditorPage({
  params,
}: {
  ...
  async function handleSave() {
    ...
    if (isNew) {
      ...
      setSaving(false);
      if (result.data) {
        router.push(`/admin/apps/${slug}/email-templates/${result.data.id}`);
      }
    } else {
  ...
  async function handleDelete() {
    ...
    setDeleting(false);
    router.push(`/admin/apps/${slug}/email-templates`);
  }
    ...
    <>
      ...
      <main className="p-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <Link
            href={`/admin/apps/${slug}/email-templates`}
