...
function ContentEditorForm({
  ...
  // Initialize form state from existing page (or defaults for new)
  ...
  // Auto-generate slug from title (derived, not effect)
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="featuredImage" className="text-xs">
                    Featured Image URL
                  </Label>
                  <Input
                    id="featuredImage"
...
export default function ContentEditorPage({
  ...
  // Key the form by page ID so it remounts with fresh state when switching pages
  return (
    <ContentEditorForm
